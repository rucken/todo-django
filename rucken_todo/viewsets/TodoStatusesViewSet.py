...
class TodoStatusesViewSet(BaseViewSet):
    model = TodoStatusSerializer.Meta.model
    serializer_class = TodoStatusSerializer
    queryset = TodoStatusSerializer.Meta.model.objects.all()
    ...
    def list(self, request, *args, **kwargs):
        ...
        return super(TodoStatusesViewSet, self).list(request, *args, **kwargs)
